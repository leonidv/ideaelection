...
class GroupsSpec : DescribeSpec({
    ...
    describe("initialization") {
        registerUsers(userA, userB, userC, userE, userD)
    }
    ...
    describe("loading members") {
        ...
        describe("pageable (skip = 0, count = 1) and return $userC") {
        ...
        describe("pageable (first = 1, count = 1) and return $userB") {
            val response = userA.groups.loadMembers(
                groupId,
                skip = 1,
                count = 1
        ...
        describe("username filter is [generated uuid] returns empty array") {
            val response = userA.groups.loadMembers(
                groupId,
                usernameFilter = UUID.randomUUID().toString()
            )
    ...
    describe("deleting members") {
        ...
        describe("group contains [$userE, $userA]") {
            ...
            describe("$userA can't leave group, because he is last admin") {
