...
class IdeaSpec : Spek({
    ...
    describe("An Idea") {
        ...
        val voterA = Voter("a@email", "a", "")
        val voterB = Voter("b@email", "b", "")
        ...
        describe("voting") {
            describe("user can vote for an idea") {
                val idea = originIdea.addVote(Voter.DUMMY.id())
                ...
                it("has voter [dummy@mail]") {
                    assertThat(idea.voters).isEqualTo(setOf(Voter.DUMMY.id()))
                }
        ...
        describe("removing vote") {
            ...
            describe("user can't remove vote for an idea without any vote") {
                val idea = originIdea.removeVote(Voter.DUMMY.id())
